...
define( 'YOURLS_DB_USER', 'kpow' );

/** MySQL database password */
define( 'YOURLS_DB_PASS', 'x4x2x0x' );

/** The name of the database for YOURLS */
define( 'YOURLS_DB_NAME', 'littlepeeboy' );

/** MySQL hostname */
define( 'YOURLS_DB_HOST', 'mysql.kpow.com' );
...
define( 'YOURLS_SITE', 'http://littlepeeboy.com' );
...
$yourls_user_passwords = array(
	'admin' => 'x4x2x0x',
	'guest' => 'b00ty'	// You can have one or more 'login'=>'password' lines
	);
